...
class MainWindow():
    ...
    def result_file(self,location,value):
        ...
        windsor_sheet = result_excel.add_worksheet('windsor')
    ...
    def data_extraction(self, excel_files):
        ...
        for i in excel_files:           
            ...
            for row in ws.iter_rows(min_row=2, max_row=10):
                ...
                #cell_column_adress=[]
                for cell in zxc:
                    #if cell not in cell_column_adress:
                        #cell_column_adress.append(cell.column)
                    ...
                    if cell.value=="Energia":
                        ...
                        #print(self.cell_info(cell))
                        #print(ws["H7"].fill.start_color.index)
                        #print(type(ws["H7"].value))
            ...
            for row in qwe:
                ...
                #print(row.fill.start_color.index)
